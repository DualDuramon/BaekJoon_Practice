...
int Problem_9019::OperD(int num) {
	return (num * 2) % 10000;
}
int Problem_9019::OperS(int num) {
	return num - 1 < 0 ? 9999 : num - 1;
}
int Problem_9019::OperR(int num) {
	return (num % 10) * 1000 + num / 10;
}

int Problem_9019::OperL(int num) {
	return num / 1000 + (num % 1000) * 10;
}

void Problem_9019::Solving() {
	int n{ 0 }, dest{ 0 };
	cin >> n >> dest;
